    ...
    <main className="flex min-h-[calc(100vh-64px)] flex-col lg:flex-row">
      ...
      <div className="flex w-full flex-col justify-center bg-white px-8 py-16 lg:w-1/2 lg:px-24">
        <div className="mx-auto w-full max-w-sm">
          ...
          <div className="mb-10">
            <h1 className="text-4xl font-black tracking-tight text-black">Create Account</h1>
            <p className="mt-3 text-lg font-bold text-black">
              Join the professional network for global ocean intelligence.
            </p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            ...
            <p className="text-center text-sm font-black text-black">
              ...
              <Link className="text-blue-600 underline decoration-2 underline-offset-4 hover:text-blue-700" href="/login">
                Sign in
              </Link>
            </p>
          </form>
